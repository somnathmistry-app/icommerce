...
import 'package:icommerce/search/search_widget.dart';
...
//     return Scaffold(body: getProductPage());
//   }
//
//
// }
...
//           String discount, String mfgName
  ...
  void searchProduct(String query) {
    if (query == "" || query == null) {
      ...
      productController.getSearchProductList(query);
    }
  }
/*
  void searchProduct(String query) {
    final products = productController.productList.value.where((product) {
    ...
    setState(() {
      // productController.productList.value = productController.productList;
      this.query = query;
      productController.productList.value = products;
    });
  }
